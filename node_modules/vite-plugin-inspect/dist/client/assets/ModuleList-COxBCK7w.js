import { Fragment, computed, createBaseVNode, createBlock, createCommentVNode, createElementBlock, createTextVNode, createVNode, defineComponent, guardReactiveProps, h, mergeProps, nextTick, normalizeClass, normalizeProps, normalizeStyle, openBlock, popScopeId, pushScopeId, ref, renderList, renderSlot, resolveComponent, toDisplayString, toRef, unref, withCtx, withDirectives, withScopeId } from "./runtime-core.esm-bundler-Ybyxq4rL.js";
import { createApp, useRoute, withKeys } from "./vue-router-Cf6P0NWg.js";
import { isDark, usePayloadStore, useVirtualList } from "./payload-BUPFZTEx.js";
import { Badge_default, PluginName_default, getPluginColor } from "./QuerySelector-DIdTvuTN.js";
import { DurationDisplay_default, NumberWithUnit_default, useOptionsStore } from "./options-M413EYxj.js";
