import { DEFAULT_OPTIONS, EditableTreeNode, Options, ResolvedOptions, ServerContext, TreeNode, TreeNodeValueParam, TreeNodeValueStatic, createTreeNodeValue, getFileBasedRouteName, getPascalCaseRouteName } from "./options-B1yf8raX.js";
...
declare function createRoutesContext(options: ResolvedOptions): {
  ...
  definePageTransform(code: string, id: string): unplugin11.Thenable<unplugin11.TransformResult>;
};
//#endregion
...
declare const _default: unplugin11.UnpluginInstance<Options | undefined, boolean>;
/**
